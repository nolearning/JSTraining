...
>当然，如果你是Emacs用户。如果你喜欢一个真正的编辑器（眨眼），本人编写了一个自定义JS高亮插件，某些情况下比内建要好：   [http://github.com/spencertipping/js-vim-highlighter](http://github.com/spencertipping/js-vim-highlighter)
